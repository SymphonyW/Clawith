...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS ix_user_tenant_onboardings_user_id ON user_tenant_onboardings(user_id)")
    op.execute("CREATE INDEX IF NOT EXISTS ix_user_tenant_onboardings_tenant_id ON user_tenant_onboardings(tenant_id)")
