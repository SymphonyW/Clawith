    ...
    async def register_connection(
        ...
        *,
        ...
        async with redis.pipeline(transaction=True) as pipe:
            ...
            # Redis 3.x does not support multi-field HSET, but portable Windows
            # builds still support HMSET. This keeps local Windows deployments
            # compatible while preserving the same stored hash shape.
            pipe.hmset(self._connection_key(connection_id), payload)
