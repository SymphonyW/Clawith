...
class OpenAICompatibleClient(LLMClient):
    ...
    async def _get_client(self) -> httpx.AsyncClient:
        ...
        if self._client is None or self._client.is_closed:
            self._client = httpx.AsyncClient(timeout=self.timeout, follow_redirects=True, proxy=None, trust_env=False)
        return self._client
    ...
    async def stream(
        ...
        **kwargs: Any,
        ...
        for attempt in range(max_retries):
            ...
            except (httpx.ConnectError, httpx.ReadError, httpx.ConnectTimeout, httpx.ReadTimeout, httpx.RemoteProtocolError) as e:
